...
struct DDSInfo
{
	DDSInfo(bool aIsCompressed, bool aSwap, bool aHasPalette, int aDivSize, int aBlockBytes, int aInternalFormat, int aExternalFormat, int aType)
...
namespace DDSLoader
{
	...
	\return Load result.
	*/
	LoadResult Load(const std::vector<uint8_t>& fileContents, int cubeMapFace, int& outWidth, int& outHeight, bool& outOpaque, Output& outOutput);
