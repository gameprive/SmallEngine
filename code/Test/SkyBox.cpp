...
GLuint SkyBox::createCubeTexture(char* folder)
{
	...
	image_path.push_back(std::string(folder) + std::string("/right.dds"));
	image_path.push_back(std::string(folder) + std::string("/left.dds"));
	image_path.push_back(std::string(folder) + std::string("/top.dds"));
	image_path.push_back(std::string(folder) + std::string("/bottom.dds"));
	image_path.push_back(std::string(folder) + std::string("/back.dds"));
	image_path.push_back(std::string(folder) + std::string("/front.dds"));
